...
useSeoMeta({
  ...
  description:
    'Знаходьте питання і відповіді до тестів ХНУРЕ та інших університетів України на платформі NURE Answers. Швидкий пошук потрібної інформації за ключовими словами та предметами.',
})
